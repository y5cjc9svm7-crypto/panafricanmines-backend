...
export const COUNTRY_META = {
  Algeria: { region: 'North Africa', cc: 'DZ' },
  Angola: { region: 'Southern Africa', cc: 'AO' },
  Benin: { region: 'West Africa', cc: 'BJ' },
  Botswana: { region: 'Southern Africa', cc: 'BW' },
  'Burkina Faso': { region: 'West Africa', cc: 'BF' },
  Burundi: { region: 'East Africa', cc: 'BI' },
  Cameroon: { region: 'Central Africa', cc: 'CM' },
  'Central African Republic': { region: 'Central Africa', cc: 'CF' },
  Chad: { region: 'Central Africa', cc: 'TD' },
  "Côte d'Ivoire": { region: 'West Africa', cc: 'CI' },
  'Democratic Republic of Congo': { region: 'Central Africa', cc: 'CD' },
  'Republic of Congo': { region: 'Central Africa', cc: 'CG' },
  Egypt: { region: 'North Africa', cc: 'EG' },
  'Equatorial Guinea': { region: 'Central Africa', cc: 'GQ' },
  Eritrea: { region: 'East Africa', cc: 'ER' },
  Eswatini: { region: 'Southern Africa', cc: 'SZ' },
  Ethiopia: { region: 'East Africa', cc: 'ET' },
  Gabon: { region: 'Central Africa', cc: 'GA' },
  Gambia: { region: 'West Africa', cc: 'GM' },
  Ghana: { region: 'West Africa', cc: 'GH' },
  Guinea: { region: 'West Africa', cc: 'GN' },
  'Guinea-Bissau': { region: 'West Africa', cc: 'GW' },
  Kenya: { region: 'East Africa', cc: 'KE' },
  Lesotho: { region: 'Southern Africa', cc: 'LS' },
  Liberia: { region: 'West Africa', cc: 'LR' },
  Libya: { region: 'North Africa', cc: 'LY' },
  Madagascar: { region: 'East Africa', cc: 'MG' },
  Malawi: { region: 'Southern Africa', cc: 'MW' },
  Mali: { region: 'West Africa', cc: 'ML' },
  ...
  Rwanda: { region: 'East Africa', cc: 'RW' },
  Senegal: { region: 'West Africa', cc: 'SN' },
  'Sierra Leone': { region: 'West Africa', cc: 'SL' },
  Somalia: { region: 'East Africa', cc: 'SO' },
  'South Africa': { region: 'Southern Africa', cc: 'ZA' },
  'South Sudan': { region: 'East Africa', cc: 'SS' },
  Sudan: { region: 'North Africa', cc: 'SD' },
  Tanzania: { region: 'East Africa', cc: 'TZ' },
...
const SAMPLE_COUNTRIES = [
  ...
  { name: 'Namibia', region: 'Southern Africa', cc: 'NA', districts: ['Erongo Region', 'Karas Region', 'Kunene Region'] },
  { name: 'Zimbabwe', region: 'Southern Africa', cc: 'ZW', districts: ['Midlands Province', 'Mashonaland West', 'Matabeleland South'] },
  { name: 'DRC', region: 'Central Africa', cc: 'CD', districts: ['Lualaba Province', 'Haut-Katanga', 'Sud-Kivu'] },
  { name: 'Ghana', region: 'West Africa', cc: 'GH', districts: ['Ashanti Region', 'Western Region', 'Eastern Region'] },
  { name: 'Burkina Faso', region: 'West Africa', cc: 'BF', districts: ['Centre-Nord Region', 'Sahel Region', 'Sud-Ouest Region'] },
  { name: 'Mali', region: 'West Africa', cc: 'ML', districts: ['Kayes Region', 'Sikasso Region'] },
  { name: 'Egypt', region: 'North Africa', cc: 'EG', districts: ['Eastern Desert', 'Sinai Peninsula'] },
];
